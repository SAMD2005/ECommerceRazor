    ...
    public class DetalleModel : PageModel
    {
        ...
        public IActionResult OnPost()
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //Aqui se manejaria la logica de agregar al carrito
                ...
                if(carritoCompraDesdeBd == null)
                {
                    ...
                    HttpContext.Session.SetInt32(CNT.CarritoSession,
                        ...
                        GetAll(u => u.ApplicationUserId == CarritoCompra.ApplicationUserId).ToList().Count());

                }
                else
                {
                    _unitOfWork.CarritoCompra.IncrementarContador(
                        carritoCompraDesdeBd, CarritoCompra.Cantidad);
